        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            ...
            className=" sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] 
                flex items-center justify-center sm:w-[570px] w-[80vm]"
          >
            <PinContainer title={link} href={link}>
              <div
                className="relative flex items-center
                        justify-center sm:w-[570px] w-[80vm] overflow-hidden 
                        sm:h-[40vh] h-[30px] mb-10"
              >
                <div
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {iconLists.map((icon) => (
                    <div key={icon} className='order border-white/[0.2] rounded-full
